...
def get(ports, settings, shared):
    def create(final):
        ...
        ports.build_port(source_path, final, port_name, includes=source_include_paths, srcs=srcs, flags=['-sSHARED_MEMORY=1'])
...
def show():
  return 'emscripten_wasmfs_squashfs (; some files emscripten original license but uses libsquashfs with LGPL-3.0-or-later license)'
